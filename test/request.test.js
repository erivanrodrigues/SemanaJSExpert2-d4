...
describe('Request helprs',() => {
    ...
    it(`should throw a timeout error when the function has spen more then ${timeout} ms`, async () => {
    ...
    it(`should return a JSON object after a request`, async ()=>{
        ...
        const expected = {ok: 'ok'}
        const pendingPrpmise = request.get('https://testing.com')
        ...
        const result = await pendingPrpmise
